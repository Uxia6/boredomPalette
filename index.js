/*function change(){
    ...
    else if($(this).hasClass("songMusic")){
...
(function(){
    ...
    app.controller("weeklyRecController", function($scope, $http){
        ...
        /*function checkMe(espec){
            if ($(espec).hasClass("hide")) {
                $(espec).removeClass("hide");
            } else{
                $(espec).addClass("hide");
            }
        };*/
    ...
    app.controller("movieController", function($scope, $http){
        ...
        $http.get(url1).then(function(res){
            ...
            /*for(i=0; i<= $scope.cinemas.length -1; i ++){
                $scope.cinema= cinemass.Similar.Results[i];
